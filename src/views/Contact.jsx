...
import { MapPin, Phone,Mail,MessageCircle,Camera,Send} from "lucide-react";
import "./Contact.css";
    ...
    <section className="contact-page">
      ...
      <div className="contact-info-section">
        ...
        <div className="contact-cards">
          <a href="https://www.google.com/maps/search/?api=1&query=Mumbai%2C%20Maharashtra%2C%20India"
            target="_blank" rel="noopener noreferrer" className="contact-card contact-clickable">
            <MapPin size={32} />
            <h3>Our Address</h3>
            <p>Beauty Bliss</p>
